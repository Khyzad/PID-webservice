...
public class IT {
	...
	public void test2() throws IOException {
		...
		Assert.assertEquals(((Citation) PC.insert(test_purlid, "first_URL", "first_ERC", "first_WHO", "first_What", "first_When").getModel().get("purl")).toJSON(),
				test_string);
	}
	...
	public void test3() throws IOException {
		String test_string ="{\"PURL\":\""+test_purlid +"\",\"URL\":\"first_URL\",\"ERC\":\"first_ERC\",\"Who\":\"first_WHO\",\"What\":\"first_What\",\"When\":\"first_When\"}";
		ResolverController PC = new ResolverController();
		Assert.assertEquals(((Citation) PC.retrieve(test_purlid).getModel().get("purl")).toJSON(),
				test_string);
	}
	...
	public void test5() throws IOException {
		...
		ResolverController PC = new ResolverController();
		Assert.assertEquals(((Citation) PC.edit(test_purlid, "first_URL_Edit").getModel().get("purl")).toJSON(),
				test_string);
	}
